...
export function getUser(accessToken) {
    return fetch(`${API_HOST}/User`, requestOptionsToken('GET', undefined, accessToken))
        .then(r => validateResponse(r));

}

export function getNewAccessToken(accessToken) {
    return fetch(`${API_HOST}/Refresh/Token`, requestOptionsToken('GET', undefined, accessToken))
        .then(r => validateResponse(r));
}
