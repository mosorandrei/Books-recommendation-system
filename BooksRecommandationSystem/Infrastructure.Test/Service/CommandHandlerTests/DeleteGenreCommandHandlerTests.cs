...
namespace Infrastructure.Test.Service
{
    public class DeleteGenreCommandHandlerTests
    {
        ...
        [Fact]
        public async Task GivenDeleteGenreCommandWhenGenreIsCalledThenDeleteAsyncGenreIsCalled()
        {
            Genre genre = new()
            {
        ...
        [Fact]
        public void GivenDeleteGenreCommandWhenHandleIsCalledAndGenreIsNullThenShouldThrowException()
        {
            Genre? genre = null;
