...
{
    public class GetMyToReadsQueryHandler : IRequestHandler<GetMyToReadsQuery, IEnumerable<BookDtoFE>>
    {
        ...
        public GetMyToReadsQueryHandler(IReadingStatusRepository repository, IBookRepository bookRepository, IBookAuthorAssociationRepository authorAssociationRepository, IAuthorRepository authorRepository, IBookGenreAssociationRepository genreAssociationRepository, IGenreRepository genreRepository)
        {
        ...
        public async Task<IEnumerable<BookDtoFE>> Handle(GetMyToReadsQuery request, CancellationToken cancellationToken)
        {
