...
{
    public class GetMyFavouritesQueryHandler : IRequestHandler<GetMyFavouritesQuery, IEnumerable<BookDtoFE>>
    {
        ...
        public GetMyFavouritesQueryHandler(IReadingStatusRepository repository, IBookRepository bookRepository, IBookAuthorAssociationRepository authorAssociationRepository, IAuthorRepository authorRepository, IBookGenreAssociationRepository genreAssociationRepository, IGenreRepository genreRepository)
        {
        ...
        public async Task<IEnumerable<BookDtoFE>> Handle(GetMyFavouritesQuery request, CancellationToken cancellationToken)
        {
            if (request.UserId == null)
                throw new ArgumentNullException(request.UserId);
            ICollection<Guid> BookIds = await repository.GetMyFavourites(request.UserId);
