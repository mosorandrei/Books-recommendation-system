...
{
    public class GetMyReadingsQueryHandler : IRequestHandler<GetMyReadingsQuery, IEnumerable<Book>>
    {
        private readonly IReadingStatusRepository repository;
        private readonly IBookRepository bookRepository;

        public GetMyReadingsQueryHandler(IReadingStatusRepository repository, IBookRepository bookRepository)
        {
            this.repository = repository;
            this.bookRepository = bookRepository;
        }
        public async Task<IEnumerable<Book>> Handle(GetMyReadingsQuery request, CancellationToken cancellationToken)
        {
